...
class penggajian extends MY_App {
	...
	public function generateData(){
		...
		$html.='<tr><th style="width: 10%">No</th><th >Jenis Gaji</th><th >Wilayah </th><th >Pusat</th><th >Cabang</th><th >Nominal</th><th >Uraian</th></tr>';
		if ($sql->num_rows<=0){
			...
			foreach($rsGaji as $rs){
				...
				$html.='</td>';
				$html.='<td >Debet : R/K Cabang';
				$html.='<br>Kredit : '.form_dropdown('cbKredit[]',$akunBank,'','id="cbKredit[]" class="form-control"');
				$html.='</td>';
				$html.='<td >Debet : Biaya Gaji Cabang';
				$html.='<br>Kredit : R/K Pusat';
				$html.='</td>';
