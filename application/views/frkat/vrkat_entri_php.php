						...
						foreach ($rsL3 as $row3){	//DISPLAY LEVEL 3
							...
							if (sizeof($rsL4)>0){
								...
								for ($x=1; $x<=sizeof($arrBulan);$x++){
									echo "<td><input type='hidden' name='idrkat_".$rowx."' id='idrkat_".$rowx."' value='".$row3->id."'>".form_input(array('name'=>'txtbdn_'.$rowx.'_'.$x,'id'=>'txtbdn_'.$rowx.'_'.$x,'class'=>'form-control', 'onkeypress'=>"return numericVal(this,event)", 'value'=>0 ))."</td>";
									...
									echo "<td>".form_input(array('name'=>'txtnom_'.$rowx.'_'.$x,'id'=>'txtnom_'.$rowx.'_'.$x,'class'=>'form-control' ,'onkeypress'=>"return numericVal(this,event)", 'value'=>0))."</td>";									
								}
								$rowx++;
							}
							echo "</tr>";
							...
							if (sizeof($rsL4)>0){
								...
								foreach ($rsL4 as $row4){	//DISPLAY LEVEL 4
									...
									//item rkat
									for ($x=1; $x<=sizeof($arrBulan);$x++){
										echo "<td><input type='hidden' name='idrkat_".$rowx."' id='idrkat_".$rowx."' value='".$row4->id."'> ".form_input(array('name'=>'txtbdn_'.$rowx.'_'.$x,'id'=>'txtbdn_'.$rowx.'_'.$x,'class'=>'form-control','onkeypress'=>"return numericVal(this,event)", 'value'=>0))."</td>";
										echo "<td>".form_input(array('name'=>'txtorg_'.$rowx.'_'.$x,'id'=>'txtorg_'.$rowx.'_'.$x,'class'=>'form-control','onkeypress'=>"return numericVal(this,event)", 'value'=>0))."</td>";
										echo "<td>".form_input(array('name'=>'txtnom_'.$rowx.'_'.$x,'id'=>'txtnom_'.$rowx.'_'.$x,'class'=>'form-control','onkeypress'=>"return numericVal(this,event)", 'value'=>0))."</td>";										
									}
									echo "</tr>";
