   ...
   <div class="panel panel-default card-view">
		...
		<div class="pull-left">
			<h6 class="panel-title txt-dark"><label id="lbltitle">Jurnal Pendapatan ZIS</label></h6>
		</div>
...
function updateForm(){
		//alert("masuk");
		var form_data = $('#frmZis').serialize();
	...
	function simpanForm(){
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo base_url('pendapatanzis/saveJurnal');?>',
			data: form_data,				
			dataType: 'json',
			success: function(msg) {
				 $("#errorHandler").html('&nbsp;').hide();
