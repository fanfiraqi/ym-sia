...
<?php echo form_open('rpb/save_sdm_entri',array('class'=>'form-horizontal','id'=>'myform'));?>
<div class="row" style="text-align:center">
	<div class="col-md-12">
		<div class="form-group">
				...
				<label class="control-label">RPB BAGIAN SDM DAN UMUM PERIODE  <?php echo $arrBulan[$bulan]." ".$tahun?></label>				
					...
					if (sizeof($rsL3)>0){
						...
						foreach ($rsL3 as $row3){	//DISPLAY LEVEL 3
							...
							if (sizeof($rsL4)>0){
								...
								$jml=$intBln."_nom";	// harga dari rkat
								

								echo "<td>".form_input(array('name'=>'txtstatus_'.$rowx,'id'=>'txtstatus_'.$rowx,'class'=>'form-control' , 'style'=> 'width:100px'))."</td>";
								echo "<td><input type='hidden' name='idrkat_".$rowx."' id='idrkat_".$rowx."' value='".$row3->id."'>".form_input(array('name'=>'txtcabunit_'.$rowx,'id'=>'txtcabunit_'.$rowx,'class'=>'form-control', 'onkeypress'=>"return numericVal(this,event)", 'value'=>1 , 'style'=> 'width:50px'))."</td>";
								echo "<td>".form_input(array('name'=>'txtcabsatuan_'.$rowx,'id'=>'txtcabsatuan_'.$rowx,'class'=>'form-control' ,'onkeypress'=>"return numericVal(this,event)", 'value'=>(sizeof($rsVal)>0?$rsVal->$jml:0), 'style'=> 'width:100px'))."</td>";
							...
							if (sizeof($rsL4)>0){
								...
								foreach ($rsL4 as $row4){	//DISPLAY LEVEL 4
									...
									echo "<td>".form_input(array('name'=>'txtstatus_'.$rowx,'id'=>'txtstatus_'.$rowx,'class'=>'form-control',  'style'=> 'width:100px'))."</td>";
									echo "<td><input type='hidden' name='idrkat_".$rowx."' id='idrkat_".$rowx."' value='".$row4->id."'> ".form_input(array('name'=>'txtcabunit_'.$rowx,'id'=>'txtcabunit_'.$rowx,'class'=>'form-control','onkeypress'=>"return numericVal(this,event)", 'value'=>1 , 'style'=> 'width:50px'))."</td>";
									echo "<td>".form_input(array('name'=>'txtcabsatuan_'.$rowx,'id'=>'txtcabsatuan_'.$rowx,'class'=>'form-control','onkeypress'=>"return numericVal(this,event)", 'value'=>(sizeof($rsVal)>0?$rsVal->$jml:0), 'style'=> 'width:100px'))."</td>";
									echo "<td>".form_input(array('name'=>'txtcabjml_'.$rowx,'id'=>'txtcabjml_'.$rowx,'class'=>'form-control','onkeypress'=>"return numericVal(this,event)", 'value'=>(sizeof($rsVal)>0?$rsVal->$jml:0), 'style'=> 'width:100px'))."</td>";	
...
$('#btsimpan').click(function(){		
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo base_url('rpb/save_sdm_entri');?>',
			data: form_data,				
			dataType: 'json',
			success: function(msg) {
				...
				if(msg.status =='success'){
					$().showMessage('Data RPB BAGIAN SDM DAN UMUM berhasil disimpan.','success',2000);
