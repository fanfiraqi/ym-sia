...
<div class="row" style="text-align:center">
	<div class="col-md-12">
		<div class="form-group">
				...
				<label class="control-label">RKAT BAGIAN SDM DAN UMUM PERIODE  <?php echo $arrBulan[$bulan]." ".$tahun?></label>
					...
					if (sizeof($rsL3)>0){
						...
						foreach ($rsL3 as $row3){	//DISPLAY LEVEL 3
							...
							if (sizeof($rsL4)>0){
								...
								$rsVal=$this->db->query("select * from rpb_sdm_detil where id_header=".$rowheader->id_header." and id_item=".$row3->id)->row();
								if (sizeof($rsVal)>0){
									$c_status=$rsVal->status;
									$c_unit=$rsVal->unit_cab;
										$c_satuan=$rsVal->satuan_cab;
