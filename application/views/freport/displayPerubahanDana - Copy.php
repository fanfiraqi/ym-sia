...
<?	$i=1;
			...
			foreach ($resList4 as $level4){
				...
				echo "<tr><td>&nbsp;</td><td>&nbsp;</td><td>".strtoupper($level4->nama)."</td>";
							if (substr($level4->idacc,0,2)=='3.' ){
								...
								//$strNya=$this->report_model->getLabaRugiValueL4Str($level4->idacc, $wilFilter, $bln, $thn);
							}else{
							//get neraca value
	...
	echo "<tr><th colspan=3 ><b>MODAL AKHIR PER  $strBulan $thn</b></th><th  ><div align=right><b>Rp.&nbsp;".number_format($jumlah[$jenis],2,',','.')."</b></div></th><th></th></tr>";
