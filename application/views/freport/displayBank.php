...
?>
<tr><th colspan="5"  class="pojokKiriBawah"><I>Saldo Akhir Bank</I></th><th class="pojokKananBawah" align=right><H4><?php echo "Rp. ".number_format($jumlah,2,',','.')?></H4></th></tr>
</table>
</div>
<?
} else{
...
<div class="row" style="text-align:center">
	<div class="col-md-12">	<input type="hidden" name="param" id="param" value="<?=$param?>">
		<!-- <button  id="btToExcel" class="btn btn-success">Cetak Xls</button>&nbsp; --><a href="<?=base_url('rptBank/result/'.$param)?>" class="btn btn-success">Cetak/Download</a><br>		
	</div>
</div>	
<?	}	?>
...
$('#btToExcel').click(function(){		
		...
		$.ajax({
			type: 'POST',
			url: '<?php echo base_url('rptBank/toExcel');?>',
